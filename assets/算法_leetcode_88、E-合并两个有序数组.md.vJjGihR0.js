import{_ as i,o as n,c as a,aj as l}from"./chunks/framework.wOgfrh2_.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"算法/leetcode/88、E-合并两个有序数组.md","filePath":"算法/leetcode/88、E-合并两个有序数组.md","lastUpdated":1772207387000}'),p={name:"算法/leetcode/88、E-合并两个有序数组.md"};function e(h,s,t,k,r,A){return n(),a("div",null,[...s[0]||(s[0]=[l(`<div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/*</span></span>
