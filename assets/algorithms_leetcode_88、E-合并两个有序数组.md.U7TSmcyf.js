import{_ as i,o as n,c as a,aj as l}from"./chunks/framework.C6wAdt62.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"algorithms/leetcode/88、E-合并两个有序数组.md","filePath":"algorithms/leetcode/88、E-合并两个有序数组.md","lastUpdated":1775475406000}'),p={name:"algorithms/leetcode/88、E-合并两个有序数组.md"};function e(h,s,t,k,r,A){return n(),a("div",null,[...s[0]||(s[0]=[l(`<div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/*</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">//    }</span></span>
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// };</span></span></code></pre></div>`,1)])])}const c=i(p,[["render",e]]);export{d as __pageData,c as default};
