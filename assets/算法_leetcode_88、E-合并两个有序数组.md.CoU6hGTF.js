import{_ as s,c as i,o as n,a5 as a}from"./chunks/framework.B7o55Ran.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"算法/leetcode/88、E-合并两个有序数组.md","filePath":"算法/leetcode/88、E-合并两个有序数组.md","lastUpdated":1718683173000}'),l={name:"算法/leetcode/88、E-合并两个有序数组.md"},p=a(`<div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">/*</span></span>
