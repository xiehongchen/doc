import{_ as a,o as n,c as p,aj as e}from"./chunks/framework.wOgfrh2_.js";const u=JSON.parse('{"title":"数据类型","description":"","frontmatter":{},"headers":[],"relativePath":"test.md","filePath":"test.md","lastUpdated":1772208348000}'),l={name:"test.md"};function i(t,s,c,r,o,d){return n(),p("div",null,[...s[0]||(s[0]=[e(`<h1 id="数据类型" tabindex="-1">数据类型 <a class="header-anchor" href="#数据类型" aria-label="Permalink to &quot;数据类型&quot;">​</a></h1><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>export enum ReactiveFlags {</span></span>
...
<span class="line"><span>}</span></span></code></pre></div>`,32)])])}const y=a(l,[["render",i]]);export{u as __pageData,y as default};
